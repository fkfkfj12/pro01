 ...
 * Generated at: 2022-10-28 02:05:41 UTC
...
public final class faqaDetail_jsp extends org.apache.jasper.runtime.HttpJspBase
...
try {
	...
	rs = pstmt.executeQuery();
      ...
      out.write("\r\n");
      out.write("<meta  charset=\"UTF-8\">\r\n");
      out.write("<title>자주하는 질문 상세보기</title>\r\n");
      out.write("</head>\r\n");
      out.write("<body>\r\n");
      out.write('\r');
      out.write('\n');
 ...
 if(rs.next()){
      ...
      out.write("\t<a href=\"faqa.jsp\" class=\"btn primary\">자주하는질문목록</a>\r\n");
      out.write("\t");

		if(sid.equals("admin") || sid.equals(author)) {
	
      out.write("\r\n");
      out.write("\t<a href='faqaModify.jsp?no=");
      out.print(rs.getInt("no") );
      out.write("' class=\"btn primary\">글 수정</a>\r\n");
      out.write("\t<a href='faqaDel.jsp?no=");
      out.print(rs.getInt("no") );
