 ...
 * Generated at: 2022-10-31 01:18:03 UTC
...
return;
 ...
 if(id!=null){ 
      ...
      out.write("               <span class=\"sel\">온라인 상담 하기</span>\r\n");
      out.write("           </div>\r\n");
      out.write("       </div>\r\n");
      out.write("       <section class=\"page\">\r\n");
      out.write("           <div class=\"page_wrap\">\r\n");
      out.write("               <h2 class=\"page_title\">온라인 상담 하기</h2>\r\n");
      out.write("               <p style=\"clear:both\">작성하여 보내신 내용은 관리자 이메일로 보내지며, 내용을 확인 후 별도 개별적으로 3일 이내 연락드립니다.</p>\r\n");
      out.write("\t\t\t");
      out.write("\r\n");
      out.write("\r\n");
...
try {
	...
	con = DriverManager.getConnection(url, dbid, dbpw);
      ...
      out.write("\t\t\t\t<form name=\"frm\" class=\"frm\" action=\"onlinePro.jsp\" method=\"post\">\r\n");
      out.write("\t\t\t\t\t<table class=\"tb\">\r\n");
      out.write("\t\t\t\t\t\t<tbody>\r\n");
      out.write("\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t<th><label for=\"author\">작성자명</label></th>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<input type=\"text\" name=\"name\" id=\"name\" class=\"in_data\" value='");
      ...
      out.write("\t\t\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<input type=\"email\" name=\"from\" id=\"from\" class=\"in_data\" value='");
      ...
      out.write("\t\t\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<input type=\"tel\" name=\"tel\" id=\"tel\" class=\"in_data\" value='");
      out.print(rs.getString("tel") );
      out.write("' required >\r\n");
      out.write("\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t<th><label for=\"title\">상담 제목</label></th>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td><input type=\"text\" name=\"title\" id=\"title\" placeholder=\"제목 입력\" maxlength=\"100\" class=\"in_data\" required></td>\r\n");
      out.write("\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t<th><label for=\"content\">상담 내용</label></th>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<textarea cols=\"100\" rows=\"6\" name=\"content\" id=\"content\" maxlength= \"600\" class=\"in_data2\"></textarea>\r\n");
      out.write("\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t</tbody>\r\n");
      out.write("\t\t\t\t\t</table>\r\n");
      out.write("\t\t\t\t\t<div class=\"btn_group\">\r\n");
      out.write("\t\t\t\t\t\t<button type=\"submit\" class=\"btn primary\">상담 받기</button>\r\n");
      out.write("\t\t\t\t\t\t<a href=\"qnaList.jsp\" class=\"btn primary\">질문 및 답변으로</a>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t</form>\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t\t");
